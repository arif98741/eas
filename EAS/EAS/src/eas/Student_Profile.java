...
public class Student_Profile extends javax.swing.JFrame {
    ...
    public Student_Profile(String sid) {
        this.stidString = sid;
...
//    }
    ...
    public void showData() {
        ...
        String sql = "select * from std_register where std_id ='" + stidString + "'";
        //shadhin changed end
    ...
    private void initComponents() {
        ...
        getContentPane().add(showemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, 260, -1));
